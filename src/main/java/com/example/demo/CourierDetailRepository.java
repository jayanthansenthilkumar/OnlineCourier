...
public interface CourierDetailRepository extends JpaRepository<CourierDetails, String> {
    ...
    List<CourierDetails> findByStatus(String status);
    
    List<CourierDetails> findByPickupCity(String pickupCity);
    
    List<CourierDetails> findByDestinationCity(String destinationCity);
}
